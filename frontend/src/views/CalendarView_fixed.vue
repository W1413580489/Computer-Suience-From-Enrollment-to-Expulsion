...
// ===== 第一学期（八、九月 ~ 二月）26 行 =====
// 修正：教职工开学日 9月3日（周四），学生上课日 9月7日（周一），春节 2月6日（周六）
const sem1: Row[] = [
  ...
  { w: 22, m: '二月', days: [31, 1, 2, 3, 4, 5, n(6, 'spring', true)] },
...
// ===== 第二学期（二月 ~ 八月）27 行 =====
// 修正：教职工开学日 2月25日（周四），学生上课日 3月1日（周一），毕业典礼 6月19日（周六）
const sem2: Row[] = [
  { w: 1, m: '二月', days: [21, 22, 23, 24, n(25, 'staff'), 26, 27] },
  ...
  { w: 21, m: '七月', days: [18, n(19, 'holiday'), 20, 21, 22, 23, 24] },
