<template>
  ...
  >
    ...
    <template v-else-if="name === 'academics'">
...
withDefaults(
  ...
  { size: 20, color: 'currentColor', strokeWidth: 1.8 },
);
</script>
...
.neon-icon {
  flex-shrink: 0;
  filter: drop-shadow(0 0 4px var(--amber-strong));
}
</style>
