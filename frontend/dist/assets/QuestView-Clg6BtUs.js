...
`)}]}],Se={class:"quest-root"},qe={class:"quest-topbar"},Te={key:1,class:"levels-root"},Be={class:"levels-header"},we={class:"levels-grid"},De=["disabled","onClick"],Le={class:"level-card__inner"},Ae={class:"level-card__icon"},Me={class:"level-card__num"},Oe={class:"level-card__title"},ze={class:"level-card__progress"},Ee={class:"level-card__bar"},Ge={key:0,class:"level-card__lock"},Je={key:1,class:"level-card__done"},Qe={key:2,class:"reader-root"},Ue={class:"reader-top"},Ve={class:"reader-top__meta"},We={class:"reader-top__icon"},Re={class:"reader-top__title"},Xe={key:0,class:"reader-top__progress"},Ke={class:"reader-section__header"},Ye={class:"reader-section__num"},Ze={class:"reader-section__title"},Fe=["innerHTML"],He={key:0,class:"reader-section__footer"},es=["onClick"],ss={class:"reader-section__check-icon"},ts={key:0,class:"reader-next-chapter"},ns={key:1,class:"reader-next-chapter"},as={key:2,class:"reader-done"},is=U({__name:"QuestView",setup(u){const m=ae(),t=Ie,c=ee(pe()),C=I(c.hasSeenIntro?"levels":"login"),b=I(0),P=I(null),r=j(()=>t.every(n=>p(n.id)===100)),y=j(()=>{for(let n=0;n<t.length;n++)if(p(t[n].id)<100)return n;return Math.min(t.length-1,3)}),R=j(()=>p("login")<100?1:p("mainline")<100?2:4),T=j(()=>b.value>=t.length-1),g=j(()=>t[b.value]??null);function p(n){const s=t.find(h=>h.id===n);if(!s||s.sections.length===0)return 0;const $=s.sections.filter(h=>f(h.id)).length;return Math.round($/s.sections.length*100)}function f(n){return c.mainComplete.includes(n)}function X(n){const s=c.mainComplete.indexOf(n);s>=0?c.mainComplete.splice(s,1):c.mainComplete.push(n),q({...c})}function K(){c.hasSeenIntro=!0,q({...c}),C.value="levels"}function Y(n){b.value=n,C.value="reading",w()}function Z(){C.value="levels"}function B(){b.value<t.length-1&&(b.value++,w())}function F(){for(const n of t)for(const s of n.sections)f(s.id)||c.mainComplete.push(s.id);q({...c}),m.push("/")}function w(){ne(()=>{P.value&&(P.value.scrollTop=0)})}return(n,s)=>{var $,h,D,L,A,M,O,z,E,G;return i(),l("div",Se,[e("header",qe,[e("button",{class:"quest-topbar__back",onClick:s[0]||(s[0]=a=>n.$router.push("/"))},[se(oe,{name:"back",size:20}),s[3]||(s[3]=e("span",{class:"quest-topbar__back-label"},"返回",-1))]),s[4]||(s[4]=e("span",{class:"quest-topbar__title"},"🎮 新手任务",-1)),s[5]||(s[5]=e("span",{class:"quest-topbar__ver"},"v2.0",-1))]),C.value==="login"?(i(),te(ue,{key:0,onDone:K})):C.value==="levels"?(i(),l("div",Te,[e("div",Be,[e("h2",null,o(r.value?"全部通关！":"选择关卡"),1),e("p",null,o(r.value?"可随意翻阅任意章节":"完成当前关卡以解锁下一关"),1)]),e("div",we,[(i(!0),l(J,null,Q(N(t),(a,v)=>(i(),l("button",{key:a.id,class:S(["level-card",{"level-card--unlocked":r.value||v<R.value,"level-card--current":!r.value&&v===y.value,"level-card--locked":!r.value&&v>y.value,"level-card--done":p(a.id)===100}]),disabled:!r.value&&v>y.value,onClick:x=>Y(v)},[e("div",Le,[e("span",Ae,o(a.icon),1),e("span",Me,"关卡 "+o(v+1),1),e("span",Oe,o(a.title),1),e("div",ze,[e("div",Ee,[e("div",{class:"level-card__fill",style:ie({width:p(a.id)+"%"})},null,4)]),e("span",null,o(p(a.id))+"%",1)]),!r.value&&v>y.value?(i(),l("span",Ge,"🔒")):p(a.id)===100?(i(),l("span",Je,"✅")):k("",!0)])],10,De))),128))])])):(i(),l("div",Qe,[e("div",Ue,[e("button",{class:"reader-top__back",onClick:Z},[...s[6]||(s[6]=[e("span",null,"← 返回关卡选择",-1)])]),e("div",Ve,[e("span",We,o(($=g.value)==null?void 0:$.icon),1),e("span",Re,o((h=g.value)==null?void 0:h.title),1)]),!r.value&&((D=g.value)==null?void 0:D.id)==="login"?(i(),l("div",Xe," 已完成 "+o(p(((L=g.value)==null?void 0:L.id)??""))+"% ",1)):k("",!0)]),e("div",{class:"reader-sections",ref_key:"sectionsEl",ref:P},[(i(!0),l(J,null,Q(((A=g.value)==null?void 0:A.sections)??[],(a,v)=>{var x;return i(),l("div",{key:a.id,class:S(["reader-section",{"reader-section--done":f(a.id)}])},[e("div",Ke,[e("span",Ye,o(v+1),1),e("h3",Ze,o(a.title),1)]),e("div",{class:"reader-section__body",innerHTML:N(le)(a.content)},null,8,Fe),!r.value&&((x=g.value)==null?void 0:x.id)==="login"?(i(),l("div",He,[e("button",{class:S(["reader-section__check",{done:f(a.id)}]),onClick:os=>X(a.id)},[s[7]||(s[7]=e("span",{class:"reader-section__glow"},null,-1)),e("span",ss,o(f(a.id)?"✓":"○"),1),e("span",null,o(f(a.id)?"已完成":"标记完成"),1)],10,es)])):k("",!0)],2)}),128)),!r.value&&((M=g.value)==null?void 0:M.id)!=="login"&&!T.value?(i(),l("div",ts,[e("button",{class:"reader-next-chapter__btn",onClick:s[1]||(s[1]=a=>B())},[e("span",null,"进入下一关："+o((O=N(t)[b.value+1])==null?void 0:O.title),1),s[8]||(s[8]=e("span",{class:"reader-next-chapter__arrow"},"→",-1))])])):k("",!0),!r.value&&((z=g.value)==null?void 0:z.id)!=="login"&&T.value?(i(),l("div",ns,[e("button",{class:"reader-next-chapter__btn reader-next-chapter__btn--home",onClick:F},[...s[9]||(s[9]=[e("span",null,"🎉 全部通关！返回首页",-1)])])])):k("",!0),!r.value&&((E=g.value)==null?void 0:E.id)==="login"&&p("login")===100?(i(),l("div",as,[s[10]||(s[10]=e("span",{class:"reader-done__icon"},"🎊",-1)),s[11]||(s[11]=e("p",null,"第一章全部完成！",-1)),e("button",{class:"reader-done__next",onClick:s[2]||(s[2]=a=>B())}," 进入下一关："+o((G=N(t)[1])==null?void 0:G.title)+" → ",1)])):k("",!0)],512)]))])}}}),ds=V(is,[["__scopeId","data-v-6f0581f7"]]);export{ds as default};
